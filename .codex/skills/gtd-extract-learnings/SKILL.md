...
<codex_skill_adapter>
## A. Skill Invocation
- This skill is invoked by mentioning `$gtd-extract-learnings`.
- Treat all user text after `$gtd-extract-learnings` as `{{GTD_ARGS}}`.
...
<execution_context>
@/Users/davide/repos/get-tasks-done-demo-app/.codex/get-tasks-done/workflows/extract-learnings.md
</execution_context>

Execute the extract-learnings workflow from @/Users/davide/repos/get-tasks-done-demo-app/.codex/get-tasks-done/workflows/extract-learnings.md end-to-end.
