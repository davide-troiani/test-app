...
metadata:
  short-description: "config workspace | workstreams thread update inbox"
---

<codex_skill_adapter>
## A. Skill Invocation
- This skill is invoked by mentioning `$gtd-ns-manage`.
- Treat all user text after `$gtd-ns-manage` as `{{GTD_ARGS}}`.
