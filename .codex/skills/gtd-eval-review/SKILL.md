...
<codex_skill_adapter>
## A. Skill Invocation
- This skill is invoked by mentioning `$gtd-eval-review`.
- Treat all user text after `$gtd-eval-review` as `{{GTD_ARGS}}`.
...
<execution_context>
@/Users/davide/repos/get-tasks-done-demo-app/.codex/get-tasks-done/workflows/eval-review.md
@/Users/davide/repos/get-tasks-done-demo-app/.codex/get-tasks-done/references/ai-evals.md
</execution_context>

<context>
Phase: {{GTD_ARGS}} — optional, defaults to last completed phase.
</context>
