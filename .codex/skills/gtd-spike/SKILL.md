...
<codex_skill_adapter>
## A. Skill Invocation
- This skill is invoked by mentioning `$gtd-spike`.
- Treat all user text after `$gtd-spike` as `{{GTD_ARGS}}`.
...
<execution_context>
@/Users/davide/repos/get-tasks-done-demo-app/.codex/get-tasks-done/workflows/spike.md
@/Users/davide/repos/get-tasks-done-demo-app/.codex/get-tasks-done/workflows/spike-wrap-up.md
...
- Otherwise: pass all of {{GTD_ARGS}} as the idea to the spike workflow end-to-end.
