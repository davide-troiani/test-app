...
<codex_skill_adapter>
## A. Skill Invocation
- This skill is invoked by mentioning `$gtd-spec-phase`.
- Treat all user text after `$gtd-spec-phase` as `{{GTD_ARGS}}`.
...
<execution_context>
@/Users/davide/repos/get-tasks-done-demo-app/.codex/get-tasks-done/workflows/spec-phase.md
@/Users/davide/repos/get-tasks-done-demo-app/.codex/get-tasks-done/templates/spec.md
</execution_context>
