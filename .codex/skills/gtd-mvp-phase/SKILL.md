...
<codex_skill_adapter>
## A. Skill Invocation
- This skill is invoked by mentioning `$gtd-mvp-phase`.
- Treat all user text after `$gtd-mvp-phase` as `{{GTD_ARGS}}`.
...
<execution_context>
@/Users/davide/repos/get-tasks-done-demo-app/.codex/get-tasks-done/workflows/mvp-phase.md
...
<context>
Phase number: {{GTD_ARGS}} (required — integer or decimal like `2.1`)
...
<process>
Execute the mvp-phase workflow from @/Users/davide/repos/get-tasks-done-demo-app/.codex/get-tasks-done/workflows/mvp-phase.md end-to-end.
