...
<codex_skill_adapter>
## A. Skill Invocation
- This skill is invoked by mentioning `$gtd-ingest-docs`.
- Treat all user text after `$gtd-ingest-docs` as `{{GTD_ARGS}}`.
...
<execution_context>
@/Users/davide/repos/get-tasks-done-demo-app/.codex/get-tasks-done/workflows/ingest-docs.md
...
@/Users/davide/repos/get-tasks-done-demo-app/.codex/get-tasks-done/references/doc-conflict-engine.md
</execution_context>
