...
<codex_skill_adapter>
## A. Skill Invocation
- This skill is invoked by mentioning `$gtd-discuss-phase`.
- Treat all user text after `$gtd-discuss-phase` as `{{GTD_ARGS}}`.
...
<context>
Phase number: {{GTD_ARGS}} (required)
...
If `--assumptions` is in {{GTD_ARGS}}:
Read and execute `/Users/davide/repos/get-tasks-done-demo-app/.codex/get-tasks-done/workflows/list-phase-assumptions.md` end-to-end.
Stop here.

Otherwise, if `DISCUSS_MODE` is `"assumptions"`:
Read and execute `/Users/davide/repos/get-tasks-done-demo-app/.codex/get-tasks-done/workflows/discuss-phase-assumptions.md` end-to-end.

Otherwise (`"discuss"` / unset / any other value):
Read and execute `/Users/davide/repos/get-tasks-done-demo-app/.codex/get-tasks-done/workflows/discuss-phase.md` end-to-end.
