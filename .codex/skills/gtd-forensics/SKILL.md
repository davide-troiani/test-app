...
metadata:
  short-description: "Post-mortem investigation for failed GTD workflows — diagnoses what went wrong."
---

<codex_skill_adapter>
## A. Skill Invocation
- This skill is invoked by mentioning `$gtd-forensics`.
- Treat all user text after `$gtd-forensics` as `{{GTD_ARGS}}`.
...
<execution_context>
@/Users/davide/repos/get-tasks-done-demo-app/.codex/get-tasks-done/workflows/forensics.md
</execution_context>
...
**User input:**
- Problem description: {{GTD_ARGS}} (optional — will ask if not provided)
</context>
