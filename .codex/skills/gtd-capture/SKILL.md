...
<codex_skill_adapter>
## A. Skill Invocation
- This skill is invoked by mentioning `$gtd-capture`.
- Treat all user text after `$gtd-capture` as `{{GTD_ARGS}}`.
...
<execution_context>
@/Users/davide/repos/get-tasks-done-demo-app/.codex/get-tasks-done/workflows/add-todo.md
@/Users/davide/repos/get-tasks-done-demo-app/.codex/get-tasks-done/workflows/note.md
@/Users/davide/repos/get-tasks-done-demo-app/.codex/get-tasks-done/workflows/add-backlog.md
@/Users/davide/repos/get-tasks-done-demo-app/.codex/get-tasks-done/workflows/plant-seed.md
@/Users/davide/repos/get-tasks-done-demo-app/.codex/get-tasks-done/workflows/check-todos.md
...
- Otherwise: pass all of {{GTD_ARGS}} to add-todo workflow
</context>

<process>
1. Parse the leading flag (if any) from {{GTD_ARGS}}.
