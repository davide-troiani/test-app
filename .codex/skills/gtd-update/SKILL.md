...
metadata:
  short-description: "Update GTD to latest version with changelog display"
---

<codex_skill_adapter>
## A. Skill Invocation
- This skill is invoked by mentioning `$gtd-update`.
- Treat all user text after `$gtd-update` as `{{GTD_ARGS}}`.
...
<execution_context>
@/Users/davide/repos/get-tasks-done-demo-app/.codex/get-tasks-done/workflows/update.md
</execution_context>
...
@/Users/davide/repos/get-tasks-done-demo-app/.codex/get-tasks-done/workflows/sync-skills.md
@/Users/davide/repos/get-tasks-done-demo-app/.codex/get-tasks-done/workflows/reapply-patches.md
</execution_context_extended>
