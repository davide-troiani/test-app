...
metadata:
  short-description: "Configure GTD workflow toggles and model profile"
---

<codex_skill_adapter>
## A. Skill Invocation
- This skill is invoked by mentioning `$gtd-settings`.
- Treat all user text after `$gtd-settings` as `{{GTD_ARGS}}`.
