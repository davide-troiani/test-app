...
<codex_skill_adapter>
## A. Skill Invocation
- This skill is invoked by mentioning `$gtd-milestone-summary`.
- Treat all user text after `$gtd-milestone-summary` as `{{GTD_ARGS}}`.
...
<execution_context>
@/Users/davide/repos/get-tasks-done-demo-app/.codex/get-tasks-done/workflows/milestone-summary.md
</execution_context>
...
**User input:**
- Version: {{GTD_ARGS}} (optional — defaults to current/latest milestone)
</context>
