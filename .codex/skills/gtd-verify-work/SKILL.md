...
<codex_skill_adapter>
## A. Skill Invocation
- This skill is invoked by mentioning `$gtd-verify-work`.
- Treat all user text after `$gtd-verify-work` as `{{GTD_ARGS}}`.
...
<execution_context>
@/Users/davide/repos/get-tasks-done-demo-app/.codex/get-tasks-done/workflows/verify-work.md
@/Users/davide/repos/get-tasks-done-demo-app/.codex/get-tasks-done/templates/UAT.md
</execution_context>

<context>
Phase: {{GTD_ARGS}} (optional)
