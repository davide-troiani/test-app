...
<codex_skill_adapter>
## A. Skill Invocation
- This skill is invoked by mentioning `$gtd-map-codebase`.
- Treat all user text after `$gtd-map-codebase` as `{{GTD_ARGS}}`.
...
<execution_context>
@/Users/davide/repos/get-tasks-done-demo-app/.codex/get-tasks-done/workflows/map-codebase.md
</execution_context>
...
- Otherwise: pass all of {{GTD_ARGS}} as focus area to the map-codebase workflow.
