...
<codex_skill_adapter>
## A. Skill Invocation
- This skill is invoked by mentioning `$gtd-graphify`.
- Treat all user text after `$gtd-graphify` as `{{GTD_ARGS}}`.
...
**CJS-only (graphify):** `graphify` subcommands are not registered on `gtd-sdk query`. Use `node /Users/davide/repos/get-tasks-done-demo-app/.codex/get-tasks-done/bin/gtd-tools.cjs graphify …` as documented in this command. Other tooling may still use `gtd-sdk query` where a handler exists.
...
Knowledge graph is disabled. To activate:
  ...
  node /Users/davide/repos/get-tasks-done-demo-app/.codex/get-tasks-done/bin/gtd-tools.cjs config-set graphify.enabled true
...
Parse `{{GTD_ARGS}}` to determine the operation mode:
...
```bash
node /Users/davide/repos/get-tasks-done-demo-app/.codex/get-tasks-done/bin/gtd-tools.cjs graphify query <term>
```
...
```bash
node /Users/davide/repos/get-tasks-done-demo-app/.codex/get-tasks-done/bin/gtd-tools.cjs graphify status
```
...
```bash
node /Users/davide/repos/get-tasks-done-demo-app/.codex/get-tasks-done/bin/gtd-tools.cjs graphify diff
```
...
```bash
node "/Users/davide/repos/get-tasks-done-demo-app/.codex/get-tasks-done/bin/gtd-tools.cjs" graphify build
```
...
graphify update . \
  ...
  && node "/Users/davide/repos/get-tasks-done-demo-app/.codex/get-tasks-done/bin/gtd-tools.cjs" graphify build snapshot \
  && node "/Users/davide/repos/get-tasks-done-demo-app/.codex/get-tasks-done/bin/gtd-tools.cjs" graphify status
```
