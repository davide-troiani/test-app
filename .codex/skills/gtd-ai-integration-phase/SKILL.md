...
<codex_skill_adapter>
## A. Skill Invocation
- This skill is invoked by mentioning `$gtd-ai-integration-phase`.
- Treat all user text after `$gtd-ai-integration-phase` as `{{GTD_ARGS}}`.
...
<execution_context>
@/Users/davide/repos/get-tasks-done-demo-app/.codex/get-tasks-done/workflows/ai-integration-phase.md
...
<context>
Phase number: {{GTD_ARGS}} — optional, auto-detects next unplanned phase if omitted.
</context>
