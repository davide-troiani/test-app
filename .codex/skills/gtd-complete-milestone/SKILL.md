...
<codex_skill_adapter>
## A. Skill Invocation
- This skill is invoked by mentioning `$gtd-complete-milestone`.
- Treat all user text after `$gtd-complete-milestone` as `{{GTD_ARGS}}`.
...
- @/Users/davide/repos/get-tasks-done-demo-app/.codex/get-tasks-done/workflows/complete-milestone.md (main workflow)
- @/Users/davide/repos/get-tasks-done-demo-app/.codex/get-tasks-done/templates/milestone-archive.md (archive template)
  </execution_context>
