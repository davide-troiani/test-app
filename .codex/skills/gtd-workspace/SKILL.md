...
metadata:
  short-description: "Manage GTD workspaces — create, list, or remove isolated workspace environments"
---

<codex_skill_adapter>
## A. Skill Invocation
- This skill is invoked by mentioning `$gtd-workspace`.
- Treat all user text after `$gtd-workspace` as `{{GTD_ARGS}}`.
...
<execution_context>
@/Users/davide/repos/get-tasks-done-demo-app/.codex/get-tasks-done/workflows/new-workspace.md
@/Users/davide/repos/get-tasks-done-demo-app/.codex/get-tasks-done/workflows/list-workspaces.md
@/Users/davide/repos/get-tasks-done-demo-app/.codex/get-tasks-done/workflows/remove-workspace.md
...
<process>
1. Parse the leading flag from {{GTD_ARGS}}.
