...
<codex_skill_adapter>
## A. Skill Invocation
- This skill is invoked by mentioning `$gtd-manager`.
- Treat all user text after `$gtd-manager` as `{{GTD_ARGS}}`.
...
<execution_context>
@/Users/davide/repos/get-tasks-done-demo-app/.codex/get-tasks-done/workflows/manager.md
...
<process>
If `--analyze-deps` is in {{GTD_ARGS}}:
Read and execute `/Users/davide/repos/get-tasks-done-demo-app/.codex/get-tasks-done/workflows/analyze-dependencies.md` end-to-end.
