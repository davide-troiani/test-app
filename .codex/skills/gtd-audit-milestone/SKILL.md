...
<codex_skill_adapter>
## A. Skill Invocation
- This skill is invoked by mentioning `$gtd-audit-milestone`.
- Treat all user text after `$gtd-audit-milestone` as `{{GTD_ARGS}}`.
...
<execution_context>
@/Users/davide/repos/get-tasks-done-demo-app/.codex/get-tasks-done/workflows/audit-milestone.md
</execution_context>

<context>
Version: {{GTD_ARGS}} (optional — defaults to current milestone)
