...
<codex_skill_adapter>
## A. Skill Invocation
- This skill is invoked by mentioning `$gtd-phase`.
- Treat all user text after `$gtd-phase` as `{{GTD_ARGS}}`.
...
<execution_context>
@/Users/davide/repos/get-tasks-done-demo-app/.codex/get-tasks-done/workflows/add-phase.md
@/Users/davide/repos/get-tasks-done-demo-app/.codex/get-tasks-done/workflows/insert-phase.md
@/Users/davide/repos/get-tasks-done-demo-app/.codex/get-tasks-done/workflows/remove-phase.md
@/Users/davide/repos/get-tasks-done-demo-app/.codex/get-tasks-done/workflows/edit-phase.md
</execution_context>
...
- Otherwise: pass all of {{GTD_ARGS}} (phase description) to add-phase workflow
