...
<codex_skill_adapter>
## A. Skill Invocation
- This skill is invoked by mentioning `$gtd-surface`.
- Treat all user text after `$gtd-surface` as `{{GTD_ARGS}}`.
...
<objective>
Manage the runtime skill surface without reinstall. Reads/writes `/Users/davide/repos/get-tasks-done-demo-app/.codex/skills/.gtd-surface.json`
...
Parse the first token of {{GTD_ARGS}}:
...
```bash
# Claude Code
RUNTIME_CONFIG_DIR=/Users/davide/repos/get-tasks-done-demo-app/.codex/skills

# Resolve commandsDir and agentsDir
COMMANDS_DIR=/Users/davide/repos/get-tasks-done-demo-app/.codex/commands/gtd
AGENTS_DIR=/Users/davide/repos/get-tasks-done-demo-app/.codex/agents
```
...
<execution_context>
Surface state file: `/Users/davide/repos/get-tasks-done-demo-app/.codex/skills/.gtd-surface.json`
Install profile marker: `/Users/davide/repos/get-tasks-done-demo-app/.codex/skills/.gtd-profile`
Engine module: `/Users/davide/repos/get-tasks-done-demo-app/.codex/get-tasks-done/bin/lib/surface.cjs`
Cluster definitions: `/Users/davide/repos/get-tasks-done-demo-app/.codex/get-tasks-done/bin/lib/clusters.cjs`
</execution_context>
