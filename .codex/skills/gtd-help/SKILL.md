...
metadata:
  short-description: "Show available GTD commands and usage guide"
---

<codex_skill_adapter>
## A. Skill Invocation
- This skill is invoked by mentioning `$gtd-help`.
- Treat all user text after `$gtd-help` as `{{GTD_ARGS}}`.
...
<execution_context>
@/Users/davide/repos/get-tasks-done-demo-app/.codex/get-tasks-done/workflows/help.md
</execution_context>
...
<process>
Follow /Users/davide/repos/get-tasks-done-demo-app/.codex/get-tasks-done/workflows/help.md with {{GTD_ARGS}}.
</process>
