...
<codex_skill_adapter>
## A. Skill Invocation
- This skill is invoked by mentioning `$gtd-new-milestone`.
- Treat all user text after `$gtd-new-milestone` as `{{GTD_ARGS}}`.
...
<execution_context>
@/Users/davide/repos/get-tasks-done-demo-app/.codex/get-tasks-done/workflows/new-milestone.md
@/Users/davide/repos/get-tasks-done-demo-app/.codex/get-tasks-done/references/questioning.md
@/Users/davide/repos/get-tasks-done-demo-app/.codex/get-tasks-done/references/ui-brand.md
@/Users/davide/repos/get-tasks-done-demo-app/.codex/get-tasks-done/templates/project.md
@/Users/davide/repos/get-tasks-done-demo-app/.codex/get-tasks-done/templates/requirements.md
</execution_context>

<context>
Milestone name: {{GTD_ARGS}} (optional - will prompt if not provided)
