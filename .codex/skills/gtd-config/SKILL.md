...
metadata:
  short-description: "Configure GTD settings — workflow toggles, advanced knobs, integrations, and model profile"
---

<codex_skill_adapter>
## A. Skill Invocation
- This skill is invoked by mentioning `$gtd-config`.
- Treat all user text after `$gtd-config` as `{{GTD_ARGS}}`.
...
<execution_context>
@/Users/davide/repos/get-tasks-done-demo-app/.codex/get-tasks-done/workflows/settings.md
@/Users/davide/repos/get-tasks-done-demo-app/.codex/get-tasks-done/workflows/settings-advanced.md
@/Users/davide/repos/get-tasks-done-demo-app/.codex/get-tasks-done/workflows/settings-integrations.md
</execution_context>
