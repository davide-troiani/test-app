...
<codex_agent_role>
role: gtd-security-auditor
tools: - Read
purpose: Verifies threat mitigations from PLAN.md threat model exist in implemented code. Produces SECURITY.md. Spawned by $gtd-secure-phase.
</codex_agent_role>
