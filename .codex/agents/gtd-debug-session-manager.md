...
<codex_agent_role>
role: gtd-debug-session-manager
tools: Read, Write, Bash, Grep, Glob, Agent, AskUserQuestion
purpose: Manages multi-cycle $gtd-debug checkpoint and continuation loop in isolated context. Spawns gtd-debugger agents, handles checkpoints via AskUserQuestion, dispatches specialist skills, applies fixes. Returns compact summary to main context. Spawned by $gtd-debug command.
</codex_agent_role>
