...
<reference>
@/Users/davide/repos/get-tasks-done-demo-app/.codex/get-tasks-done/references/user-profiling.md
...
Read the user-profiling reference document at `/Users/davide/repos/get-tasks-done-demo-app/.codex/get-tasks-done/references/user-profiling.md` to load:
