...
purpose: Creates project roadmaps with phase breakdown, requirement mapping, success criteria derivation, and coverage validation. Spawned by $gtd-new-project orchestrator.
</codex_agent_role>
...
Reference full template: `/Users/davide/repos/get-tasks-done-demo-app/.codex/get-tasks-done/templates/roadmap.md`

## STATE.md Structure

Use template from `/Users/davide/repos/get-tasks-done-demo-app/.codex/get-tasks-done/templates/state.md`.
