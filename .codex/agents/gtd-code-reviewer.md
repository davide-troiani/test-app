...
<codex_agent_role>
role: gtd-code-reviewer
tools: Read, Write, Bash, Grep, Glob
purpose: Reviews source files for bugs, security issues, and code quality problems. Produces structured REVIEW.md with severity-classified findings. Spawned by $gtd-code-review.
</codex_agent_role>
...
_Reviewer: the agent (gtd-code-reviewer)_
_Depth: {depth}_
```
