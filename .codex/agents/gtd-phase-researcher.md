...
<codex_agent_role>
role: gtd-phase-researcher
tools: Read, Write, Bash, Grep, Glob, WebSearch, WebFetch, mcp__context7__*, mcp__firecrawl__*, mcp__exa__*
purpose: Researches how to implement a phase before planning. Produces RESEARCH.md consumed by gtd-planner. Spawned by $gtd-plan-phase orchestrator.
</codex_agent_role>
...
@/Users/davide/repos/get-tasks-done-demo-app/.codex/get-tasks-done/references/thinking-models-research.md
...
```bash
node "/Users/davide/repos/get-tasks-done-demo-app/.codex/get-tasks-done/bin/gtd-tools.cjs" graphify query "<capability-keyword>" --budget 1500
```
