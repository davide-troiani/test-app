...
<required_reading>
@/Users/davide/repos/get-tasks-done-demo-app/.codex/get-tasks-done/references/verification-overrides.md
...
@/Users/davide/repos/get-tasks-done-demo-app/.codex/get-tasks-done/references/thinking-models-verification.md

At verification decision points, reference calibration examples:
@/Users/davide/repos/get-tasks-done-demo-app/.codex/get-tasks-done/references/few-shot-examples/verifier.md
...
**When the phase under verification has `mode: mvp` in ROADMAP.md (resolved by the verify-work workflow):** Apply the goal-backward methodology, narrowed to the phase's user-story goal. Required reading: `@/Users/davide/repos/get-tasks-done-demo-app/.codex/get-tasks-done/references/verify-mvp-mode.md`.
