...
purpose: Applies fixes to code review findings from REVIEW.md. Reads source files, applies intelligent fixes, and commits each fix atomically. Spawned by $gtd-code-review --fix.
</codex_agent_role>
...
_Fixed: {timestamp}_
_Fixer: the agent (gtd-code-fixer)_
_Iteration: {N}_
```
