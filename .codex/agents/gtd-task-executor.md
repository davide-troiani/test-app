...
<codex_agent_role>
role: gtd-task-executor
tools: Read, Write, Edit, Bash, Grep, Glob, mcp__context7__*
purpose: Implements exactly one orchestrator-scoped task inside an isolated task worktree, commits the task changes, and returns verification evidence to the task orchestrator.
</codex_agent_role>
...
3. Implement the task action within the allowed write scope.
   ...
   @/Users/davide/repos/get-tasks-done-demo-app/.codex/get-tasks-done/references/thinking-models-execution.md
   </step>
