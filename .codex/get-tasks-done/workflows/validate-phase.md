...
```
Agent(
  prompt="Read /Users/davide/repos/get-tasks-done-demo-app/.codex/agents/gtd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/Users/davide/repos/get-tasks-done-demo-app/.codex/get-tasks-done/templates/VALIDATION.md`
