...
> `--power` is present in `{{GTD_ARGS}}`. The full step-by-step instructions
...
```
Read @/Users/davide/repos/get-tasks-done-demo-app/.codex/get-tasks-done/workflows/discuss-phase-power.md
```
