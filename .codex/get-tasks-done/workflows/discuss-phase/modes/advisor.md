...
> `/Users/davide/repos/get-tasks-done-demo-app/.codex/get-tasks-done/USER-PROFILE.md` exists). Skip the Read
...
```bash
PROFILE_CONTENT=$(cat "/Users/davide/repos/get-tasks-done-demo-app/.codex/get-tasks-done/USER-PROFILE.md" 2>/dev/null || true)
```
...
2. For EACH user-selected gray area, spawn a `Agent()` in parallel:
   ...
   ```
   Agent(
     prompt="First, read @/Users/davide/repos/get-tasks-done-demo-app/.codex/agents/gtd-advisor-researcher.md for your role and instructions.
