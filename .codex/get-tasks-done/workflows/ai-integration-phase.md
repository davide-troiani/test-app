...
<required_reading>
@/Users/davide/repos/get-tasks-done-demo-app/.codex/get-tasks-done/references/ai-frameworks.md
@/Users/davide/repos/get-tasks-done-demo-app/.codex/get-tasks-done/references/ai-evals.md
</required_reading>
...
Extract phase number from {{GTD_ARGS}}. If not provided, detect next unplanned phase.
...
```markdown
Read /Users/davide/repos/get-tasks-done-demo-app/.codex/agents/gtd-framework-selector.md for instructions.
...
Copy template:
```bash
cp "/Users/davide/repos/get-tasks-done-demo-app/.codex/get-tasks-done/templates/AI-SPEC.md" "${PHASE_DIR}/${PADDED_PHASE}-AI-SPEC.md"
```
...
```markdown
Read /Users/davide/repos/get-tasks-done-demo-app/.codex/agents/gtd-ai-researcher.md for instructions.
...
```markdown
Read /Users/davide/repos/get-tasks-done-demo-app/.codex/agents/gtd-domain-researcher.md for instructions.
...
```markdown
Read /Users/davide/repos/get-tasks-done-demo-app/.codex/agents/gtd-eval-planner.md for instructions.
