...
Key references:
- @/Users/davide/repos/get-tasks-done-demo-app/.codex/get-tasks-done/references/ui-brand.md (display patterns)
- @/Users/davide/repos/get-tasks-done-demo-app/.codex/agents/gtd-user-profiler.md (profiler agent definition)
- @/Users/davide/repos/get-tasks-done-demo-app/.codex/get-tasks-done/references/user-profiling.md (profiling reference doc)
</required_reading>
...
```bash
PROFILE_PATH="/Users/davide/repos/get-tasks-done-demo-app/.codex/get-tasks-done/USER-PROFILE.md"
...
```bash
cp "/Users/davide/repos/get-tasks-done-demo-app/.codex/get-tasks-done/USER-PROFILE.md" "/Users/davide/repos/get-tasks-done-demo-app/.codex/USER-PROFILE.backup.md"
```
...
✓ Stores profile at /Users/davide/repos/get-tasks-done-demo-app/.codex/get-tasks-done/USER-PROFILE.md
...
- The user-profiling reference doc at `/Users/davide/repos/get-tasks-done-demo-app/.codex/get-tasks-done/references/user-profiling.md`
...
Reference: @/Users/davide/repos/get-tasks-done-demo-app/.codex/get-tasks-done/references/user-profiling.md
...
Display: "✓ Profile written to /Users/davide/repos/get-tasks-done-demo-app/.codex/get-tasks-done/USER-PROFILE.md"
...
- options (ALL pre-selected by default):
  ...
  - "Global AGENTS.md" -- "Add profile to /Users/davide/repos/get-tasks-done-demo-app/.codex/AGENTS.md for all projects"

**If no artifacts selected:** Display "No artifacts generated. Your profile is saved at /Users/davide/repos/get-tasks-done-demo-app/.codex/get-tasks-done/USER-PROFILE.md" and jump to step 10.
...
Display: "✓ Generated $gtd-dev-preferences at /Users/davide/repos/get-tasks-done-demo-app/.codex/skills/gtd-dev-preferences/SKILL.md"
...
Display: "✓ Added profile section to /Users/davide/repos/get-tasks-done-demo-app/.codex/AGENTS.md"
...
```bash
BACKUP_PATH="/Users/davide/repos/get-tasks-done-demo-app/.codex/USER-PROFILE.backup.md"
```
...
Your profile:    /Users/davide/repos/get-tasks-done-demo-app/.codex/get-tasks-done/USER-PROFILE.md
```

Then list paths for each generated artifact:
```
Artifacts:
  ✓ $gtd-dev-preferences   /Users/davide/repos/get-tasks-done-demo-app/.codex/skills/gtd-dev-preferences/SKILL.md
  ✓ AGENTS.md section       ./AGENTS.md
  ✓ Global AGENTS.md        /Users/davide/repos/get-tasks-done-demo-app/.codex/AGENTS.md
```
