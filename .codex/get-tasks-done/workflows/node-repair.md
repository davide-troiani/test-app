<purpose>
Autonomous repair operator for failed task verification. Invoked by task execution when a task fails its done-criteria. Proposes and attempts structured fixes before escalating to the user.
</purpose>
