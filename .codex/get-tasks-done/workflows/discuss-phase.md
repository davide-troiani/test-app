...
<required_reading>
@/Users/davide/repos/get-tasks-done-demo-app/.codex/get-tasks-done/references/domain-probes.md
@/Users/davide/repos/get-tasks-done-demo-app/.codex/get-tasks-done/references/gate-prompts.md
@/Users/davide/repos/get-tasks-done-demo-app/.codex/get-tasks-done/references/universal-anti-patterns.md
</required_reading>
...
| When | Read |
|---|---|
| `--power` in {{GTD_ARGS}} | `workflows/discuss-phase/modes/power.md` (then exit standard flow) |
| `--all` in {{GTD_ARGS}} | `workflows/discuss-phase/modes/all.md` overlay |
| `--auto` in {{GTD_ARGS}} | `workflows/discuss-phase/modes/auto.md` + `workflows/discuss-phase/modes/chain.md` (auto-advance) |
| `--chain` in {{GTD_ARGS}} | `workflows/discuss-phase/modes/default.md` + `workflows/discuss-phase/modes/chain.md` |
| `--text` in {{GTD_ARGS}} or `workflow.text_mode: true` | `workflows/discuss-phase/modes/text.md` overlay |
| `--batch` in {{GTD_ARGS}} | `workflows/discuss-phase/modes/batch.md` overlay |
| `--analyze` in {{GTD_ARGS}} | `workflows/discuss-phase/modes/analyze.md` overlay |
...
**Mode dispatch — Read mode files lazily based on flags in {{GTD_ARGS}}:**

```bash
# Detect advisor mode (file-existence guard — no Read until needed)
if [ -f "/Users/davide/repos/get-tasks-done-demo-app/.codex/get-tasks-done/USER-PROFILE.md" ]; then
  ADVISOR_MODE=true
else
  ADVISOR_MODE=false
fi
...
- If `--power` in {{GTD_ARGS}}: `Read(workflows/discuss-phase/modes/power.md)` and execute it end-to-end. Do NOT continue with the steps below.
...
Read `@/Users/davide/repos/get-tasks-done-demo-app/.codex/get-tasks-done/references/scout-codebase.md` — it contains the phase-type→map selection table, single-read rule, no-maps fallback, and `<codebase_context>` output schema. Then execute:
