...
don't see GTD transient artifacts (PLAN.md, SUMMARY.md, CONTEXT.md, RESEARCH.md, etc.)
...
Parse `{{GTD_ARGS}}` for target branch (default: `main`).
...
- `.planning/codebase/**`
- `.planning/ui-reviews/**`
- `.planning/github/**` (issue export and orchestration manifests)
...
for HASH in $CODE_AND_STRUCTURAL_COMMITS; do
  ...
  for dir in phases quick research threads todos debug seeds codebase ui-reviews github; do
