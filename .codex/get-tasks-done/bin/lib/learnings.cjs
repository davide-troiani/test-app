 ...
 *
 * Provides a cross-project learnings store at ~/.gtd/knowledge/.
...
const DEFAULT_STORE_DIR = path.join(os.homedir(), '.gtd', 'knowledge');
...
/**
 * Handle `gtd-tools learnings list`
...
/**
 * Handle `gtd-tools learnings query --tag <tag>`
 * @param {string} tag
 * @param {boolean} raw - Raw output flag
 */
...
/**
 * Handle `gtd-tools learnings copy`
...
/**
 * Handle `gtd-tools learnings prune --older-than <duration>`
...
/**
 * Handle `gtd-tools learnings delete <id>`
 * @param {string} id
 * @param {boolean} raw - Raw output flag
 */
