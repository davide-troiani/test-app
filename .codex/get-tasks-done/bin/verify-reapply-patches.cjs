...
/**
 * Deterministic verifier for the /gtd-reapply-patches Step 5 "Hunk Verification
 ...
 *     --patches-dir <path>        \  # gtd-local-patches/
 *     --config-dir <path>         \  # ~/.claude (or runtime equivalent)
 *     [--pristine-dir <path>]        # gtd-pristine/; if absent, falls back to
