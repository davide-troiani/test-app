...
When `workflow.tdd_mode` is enabled, the task orchestration flow orchestrator inserts a collaborative review checkpoint after all waves complete but before phase verification.
