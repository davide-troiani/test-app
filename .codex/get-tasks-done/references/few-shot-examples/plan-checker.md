...
**Input:** Two plans in wave 1 -- Plan 01 modifies `get-tasks-done/workflows/work-task-issue.md`, Plan 02 also modifies `get-tasks-done/workflows/work-task-issue.md`. No `depends_on` declared.
...
>     severity: BLOCKER
>     finding: "Plans 01 and 02 both modify get-tasks-done/workflows/work-task-issue.md in wave 1 with no depends_on relationship. Concurrent execution will cause merge conflicts or lost changes."
