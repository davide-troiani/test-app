...
|----------|---------------|---------------|-------|
| plan-phase | gtd-planner | gtd-plan-checker | Revision prompt via planner-revision.md |
| task orchestration flow | gtd-task-executor | gtd-verifier | Post-execution verification |
| discuss-phase | orchestrator | gtd-plan-checker | Inline revision by orchestrator |
