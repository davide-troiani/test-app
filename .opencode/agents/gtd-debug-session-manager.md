...
description: Manages multi-cycle /gtd-debug checkpoint and continuation loop in isolated context. Spawns gtd-debugger agents, handles checkpoints via question, dispatches specialist skills, applies fixes. Returns compact summary to main context. Spawned by /gtd-debug command.
mode: subagent
---
