...
Reference full template: `/Users/davide/repos/get-tasks-done-demo-app/.opencode/get-tasks-done/templates/roadmap.md`

## STATE.md Structure

Use template from `/Users/davide/repos/get-tasks-done-demo-app/.opencode/get-tasks-done/templates/state.md`.
