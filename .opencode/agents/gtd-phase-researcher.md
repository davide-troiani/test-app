...
@/Users/davide/repos/get-tasks-done-demo-app/.opencode/get-tasks-done/references/thinking-models-research.md
...
```bash
node "/Users/davide/repos/get-tasks-done-demo-app/.opencode/get-tasks-done/bin/gtd-tools.cjs" graphify query "<capability-keyword>" --budget 1500
```
