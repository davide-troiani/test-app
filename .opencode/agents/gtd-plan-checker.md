...
@/Users/davide/repos/get-tasks-done-demo-app/.opencode/get-tasks-done/references/few-shot-examples/plan-checker.md
...
- [ ] Architectural tier compliance, cross-plan data contracts, AGENTS.md conventions, and task atomicity checked
