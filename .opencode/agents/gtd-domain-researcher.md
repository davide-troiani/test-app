...
<required_reading>
Read `/Users/davide/repos/get-tasks-done-demo-app/.opencode/get-tasks-done/references/ai-evals.md` — specifically the rubric design and domain expert sections.
</required_reading>
