...
<required_reading>
Read `/Users/davide/repos/get-tasks-done-demo-app/.opencode/get-tasks-done/references/ai-frameworks.md` for framework profiles and known pitfalls before fetching docs.
</required_reading>
