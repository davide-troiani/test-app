...
- Usage: Reference from command with `@/Users/davide/repos/get-tasks-done-demo-app/.opencode/get-tasks-done/workflows/{name}.md`
...
**get-tasks-done/**
- Purpose: Resources installed to /Users/davide/repos/get-tasks-done-demo-app/.opencode/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to /Users/davide/repos/get-tasks-done-demo-app/.opencode/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
