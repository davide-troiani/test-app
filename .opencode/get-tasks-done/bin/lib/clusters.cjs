 ...
 *
 * Each cluster is a named group of skill stems. Clusters are used by /gtd:surface
 ...
 *
 * Source: skill-surface budget audit, verified against the commands/gtd/
 * listing in surface-clusters.test.cjs.
 */
