 ...
 * Called by: gtd-tools.cjs audit-open
 * Used by: /gtd:complete-milestone pre-close gate
 */
...
// per workflows/work-task-issue.md). Hoisted outside scanUatGaps so the Set is
