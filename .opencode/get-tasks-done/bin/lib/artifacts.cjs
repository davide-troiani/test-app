/**
 * Canonical GTD artifact registry.
 *
 * Enumerates the file names that gtd workflows officially produce at the
 * .planning/ root level. Used by gtd-health (W019) to flag unrecognized files
...
const CANONICAL_PATTERNS = [
  /^v\d+\.\d+(?:\.\d+)?-MILESTONE-AUDIT\.md$/i,  // gtd-complete-milestone (pre-archive)
