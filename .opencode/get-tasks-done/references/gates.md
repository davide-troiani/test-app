...
Canonical gate types used across GTD workflows. Every validation checkpoint maps to one of these four types.
...
- STATE.md in error state blocking /gtd-next
...
| task issue workflow | Entry | Pre-flight | PLAN.md and task manifest | Block with missing-plan or missing-manifest message |
| task issue workflow | Completion | Revision | SUMMARY.md completeness | Re-run incomplete task or reconciliation work |
