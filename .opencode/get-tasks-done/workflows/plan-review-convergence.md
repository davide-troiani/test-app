...
```bash
INIT=$(node "/Users/davide/repos/get-tasks-done-demo-app/.opencode/get-tasks-done/bin/gtd-tools.cjs" init plan-phase "$PHASE")
...
```bash
PHASE_INFO=$(node "/Users/davide/repos/get-tasks-done-demo-app/.opencode/get-tasks-done/bin/gtd-tools.cjs" roadmap get-phase "${PHASE}")
```
...
```bash
node "/Users/davide/repos/get-tasks-done-demo-app/.opencode/get-tasks-done/bin/gtd-tools.cjs" state planned-phase --phase "${PHASE}" --name "${phase_name}" --plans "${PLAN_COUNT}"
```
