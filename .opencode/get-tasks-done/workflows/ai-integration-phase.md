...
<required_reading>
@/Users/davide/repos/get-tasks-done-demo-app/.opencode/get-tasks-done/references/ai-frameworks.md
@/Users/davide/repos/get-tasks-done-demo-app/.opencode/get-tasks-done/references/ai-evals.md
</required_reading>
...
```markdown
Read /Users/davide/repos/get-tasks-done-demo-app/.opencode/agents/gtd-framework-selector.md for instructions.
...
Copy template:
```bash
cp "/Users/davide/repos/get-tasks-done-demo-app/.opencode/get-tasks-done/templates/AI-SPEC.md" "${PHASE_DIR}/${PADDED_PHASE}-AI-SPEC.md"
```
...
```markdown
Read /Users/davide/repos/get-tasks-done-demo-app/.opencode/agents/gtd-ai-researcher.md for instructions.
...
```markdown
Read /Users/davide/repos/get-tasks-done-demo-app/.opencode/agents/gtd-domain-researcher.md for instructions.
...
```markdown
Read /Users/davide/repos/get-tasks-done-demo-app/.opencode/agents/gtd-eval-planner.md for instructions.
