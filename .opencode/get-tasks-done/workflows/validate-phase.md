...
```
Agent(
  prompt="Read /Users/davide/repos/get-tasks-done-demo-app/.opencode/agents/gtd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/Users/davide/repos/get-tasks-done-demo-app/.opencode/get-tasks-done/templates/VALIDATION.md`
