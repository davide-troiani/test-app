...
**MVP-mode UAT framing.** When `MVP_MODE=true`, follow the rules in `@/Users/davide/repos/get-tasks-done-demo-app/.opencode/get-tasks-done/references/verify-mvp-mode.md`. Briefly:
...
Read and follow `/Users/davide/repos/get-tasks-done-demo-app/.opencode/get-tasks-done/workflows/transition.md`.
...
- Follow @/Users/davide/repos/get-tasks-done-demo-app/.opencode/get-tasks-done/workflows/diagnose-issues.md
