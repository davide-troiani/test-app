...
```bash
INIT=$(node "/Users/davide/repos/get-tasks-done-demo-app/.opencode/get-tasks-done/bin/gtd-tools.cjs" init ingest-docs)
...
```bash
node "/Users/davide/repos/get-tasks-done-demo-app/.opencode/get-tasks-done/bin/gtd-tools.cjs" commit \
