...
Key references:
- @/Users/davide/repos/get-tasks-done-demo-app/.opencode/get-tasks-done/references/ui-brand.md (display patterns)
- @/Users/davide/repos/get-tasks-done-demo-app/.opencode/agents/gtd-user-profiler.md (profiler agent definition)
- @/Users/davide/repos/get-tasks-done-demo-app/.opencode/get-tasks-done/references/user-profiling.md (profiling reference doc)
</required_reading>
...
```bash
PROFILE_PATH="/Users/davide/repos/get-tasks-done-demo-app/.opencode/get-tasks-done/USER-PROFILE.md"
...
```bash
cp "/Users/davide/repos/get-tasks-done-demo-app/.opencode/get-tasks-done/USER-PROFILE.md" "/Users/davide/repos/get-tasks-done-demo-app/.opencode/USER-PROFILE.backup.md"
```
...
✓ Stores profile at /Users/davide/repos/get-tasks-done-demo-app/.opencode/get-tasks-done/USER-PROFILE.md
...
- The user-profiling reference doc at `/Users/davide/repos/get-tasks-done-demo-app/.opencode/get-tasks-done/references/user-profiling.md`
...
Reference: @/Users/davide/repos/get-tasks-done-demo-app/.opencode/get-tasks-done/references/user-profiling.md
...
Display: "✓ Profile written to /Users/davide/repos/get-tasks-done-demo-app/.opencode/get-tasks-done/USER-PROFILE.md"
...
- options (ALL pre-selected by default):
  ...
  - "Global AGENTS.md" -- "Add profile to /Users/davide/repos/get-tasks-done-demo-app/.opencode/AGENTS.md for all projects"

**If no artifacts selected:** Display "No artifacts generated. Your profile is saved at /Users/davide/repos/get-tasks-done-demo-app/.opencode/get-tasks-done/USER-PROFILE.md" and jump to step 10.
...
Display: "✓ Generated /gtd-dev-preferences at /Users/davide/repos/get-tasks-done-demo-app/.opencode/skills/gtd-dev-preferences/SKILL.md"
...
Display: "✓ Added profile section to /Users/davide/repos/get-tasks-done-demo-app/.opencode/AGENTS.md"

**Error handling:** If any `gtd-sdk query` or gtd-tools.cjs call fails, display the error message and use question to offer "Retry" or "Skip this artifact". On retry, re-run the command. On skip, continue to next artifact.
...
```bash
BACKUP_PATH="/Users/davide/repos/get-tasks-done-demo-app/.opencode/USER-PROFILE.backup.md"
```
...
Your profile:    /Users/davide/repos/get-tasks-done-demo-app/.opencode/get-tasks-done/USER-PROFILE.md
```

Then list paths for each generated artifact:
```
Artifacts:
  ✓ /gtd-dev-preferences   /Users/davide/repos/get-tasks-done-demo-app/.opencode/skills/gtd-dev-preferences/SKILL.md
  ✓ AGENTS.md section       ./AGENTS.md
  ✓ Global AGENTS.md        /Users/davide/repos/get-tasks-done-demo-app/.opencode/AGENTS.md
```
