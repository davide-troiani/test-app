...
INSTALL_JS_GLOBAL="/Users/davide/repos/get-tasks-done-demo-app/.opencode/get-tasks-done/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node /Users/davide/repos/get-tasks-done-demo-app/.opencode/get-tasks-done/bin/install.js --global --<runtime>
```
Then exit.
