...
- **Global scope**: `/Users/davide/repos/get-tasks-done-demo-app/.opencode/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/davide/repos/get-tasks-done-demo-app/.opencode/notes/`)
...
2. Glob `/Users/davide/repos/get-tasks-done-demo-app/.opencode/notes/*.md` (if directory exists) — global notes
...
Global (/Users/davide/repos/get-tasks-done-demo-app/.opencode/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/davide/repos/get-tasks-done-demo-app/.opencode/notes/` — works in any directory
