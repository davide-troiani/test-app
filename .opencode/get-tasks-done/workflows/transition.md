...
```text
@/Users/davide/repos/get-tasks-done-demo-app/.opencode/get-tasks-done/workflows/graduation.md
```
...
Exit skill and invoke skill("/gtd-plan-phase [X+1] --auto ${GTD_WS}")
...
Exit skill and invoke skill("/gtd-discuss-phase [X+1] --auto ${GTD_WS}")
...
Exit skill and invoke skill("/gtd-complete-milestone {version} ${GTD_WS}")
