...
```bash
INIT=$(node "/Users/davide/repos/get-tasks-done-demo-app/.opencode/get-tasks-done/bin/gtd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @/Users/davide/repos/get-tasks-done-demo-app/.opencode/get-tasks-done/templates/spec.md.
