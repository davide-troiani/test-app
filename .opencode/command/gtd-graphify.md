...
**CJS-only (graphify):** `graphify` subcommands are not registered on `gtd-sdk query`. Use `node /Users/davide/repos/get-tasks-done-demo-app/.opencode/get-tasks-done/bin/gtd-tools.cjs graphify …` as documented in this command. Other tooling may still use `gtd-sdk query` where a handler exists.
...
Knowledge graph is disabled. To activate:
  ...
  node /Users/davide/repos/get-tasks-done-demo-app/.opencode/get-tasks-done/bin/gtd-tools.cjs config-set graphify.enabled true
...
```bash
node /Users/davide/repos/get-tasks-done-demo-app/.opencode/get-tasks-done/bin/gtd-tools.cjs graphify query <term>
```
...
```bash
node /Users/davide/repos/get-tasks-done-demo-app/.opencode/get-tasks-done/bin/gtd-tools.cjs graphify status
```
...
```bash
node /Users/davide/repos/get-tasks-done-demo-app/.opencode/get-tasks-done/bin/gtd-tools.cjs graphify diff
```
...
```bash
node "/Users/davide/repos/get-tasks-done-demo-app/.opencode/get-tasks-done/bin/gtd-tools.cjs" graphify build
```
...
graphify update . \
  ...
  && node "/Users/davide/repos/get-tasks-done-demo-app/.opencode/get-tasks-done/bin/gtd-tools.cjs" graphify build snapshot \
  && node "/Users/davide/repos/get-tasks-done-demo-app/.opencode/get-tasks-done/bin/gtd-tools.cjs" graphify status
```
